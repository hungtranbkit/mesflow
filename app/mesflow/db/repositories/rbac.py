...
SEED_ROLES = (
    ...
    ('supervisor', 'Quản đốc', 'Điều hành ca, phiên làm việc và dữ liệu xưởng', 30),
...
SEED_PERMISSIONS = (
    ...
    ('session.view', 'Phiên làm việc', 'Xem phiên làm việc', 'session-management', 'view', 50),
    ('session.edit', 'Phiên làm việc', 'Chỉnh sửa phiên làm việc', 'session-management', 'edit', 51),
    ('exceptions.view', 'Phiên làm việc bất thường', 'Xem các phiên làm việc bất thường', 'session-exceptions', 'view', 60),
    ('exceptions.resolve', 'Phiên làm việc bất thường', 'Xử lý phiên làm việc bất thường', 'session-exceptions', 'edit', 61),
...
SEED_ROLE_PERMISSIONS = tuple(sorted({
    ...
    ('supervisor', 'rework.resolve'),
    ('supervisor', 'rework.view'),
