  ...
  window.openMaterialFlowTrace=async function(operationId){
    ...
    try{
      ...
      body.innerHTML=`
        ...
        <section class="mf-section"><div class="mf-section-head"><div><h3>Lịch sử cấp đầu vào</h3><p>Mỗi dòng ghi nhận một lần session của OP đích nhận đầu vào.</p></div><span>${items.length} dòng</span></div>
