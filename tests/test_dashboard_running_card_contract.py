...
def test_ng_quantity_is_still_shown_plainly_not_as_an_error():
    ...
    # Defect/NG quantity must remain visible -- user-facing copy says "Lỗi"
    # while the internal defect/NG semantics and styling stay unchanged.
    #
    ...
    # đưa ra màn hình, vẫn mang nhãn "Lỗi") thay vì bám vào một chuỗi cụ thể --
    ...
    assert "Lỗi ${qtyValue(defect" in foundation, "hàm dựng chung không còn gắn nhãn Lỗi"
